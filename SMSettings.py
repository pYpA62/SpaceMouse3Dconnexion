...
def get_groups() -> Dict[str, List[str]]:
    return {
        "Movement Factors": ["move_factor", "rotation_factor", "zoom_factor"],
...
def get_defaults() -> Dict[str, Tuple[float, float, float, float]]:
    return {
        # Movement factors
        "move_factor": (0.005, 0.001, 1.0, 0.001),
        "rotation_factor": (0.01, 0.001, 2.0, 0.001),
        "zoom_factor": (0.01, 0.001, 2.0, 0.001),
        
        # Thresholds
        "threshold_xy": (12.0, 0.5, 20.0, 0.5),
        "threshold_rotation": (12.0, 0.5, 20.0, 0.5),
        "threshold_z": (10.0, 0.5, 20.0, 0.5),
        
        # Kalman filter
        "kalman_R": (6.0, 0.1, 10.0, 0.1),
        "kalman_Q": (0.05, 0.001, 1.0, 0.001),
        
        # Thread settings
        "update_interval": (0.01, 0.001, 0.1, 0.001),
        "scale_factor": (100.0, 10.0, 1000.0, 10.0),
